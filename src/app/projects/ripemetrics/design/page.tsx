...
export const metadata: Metadata = generateSiteMetadata({
    ...
    description:
        "Design case study: 4,666 Figma frames across 9 phases — brand creation, design sprints with a UX/UI design team, 180+ production screens, mobile app, and email design system for an AI-powered customer growth platform.",
