...
const learningIcons = [RefreshCcw, Layers, Wrench]
...
export function SituationSection({ data }: { data: SituationData }) {
    return (
        <motion.section
            initial="hidden"
            whileInView="visible"
...
export function ArchitectureSection({ data }: { data: ArchitectureData }) {
    return (
        <motion.section
            initial="hidden"
            whileInView="visible"
        ...
        >
            ...
            >
                {data.subsystems.map((sub) => {
                    const Icon = subsystemIcons[sub.title] ?? Terminal
...
export function DeepDiveSection({ data }: { data: DeepDive }) {
    return (
        ...
        >
            ...
            <motion.div
                variants={itemVariants}
                className="rounded-lg border-l-4 border-l-orange-500 bg-muted/50 p-6"
            >
...
export function LearningsGrid({ learnings }: { learnings: Learning[] }) {
    return (
        <motion.section
            initial="hidden"
            whileInView="visible"
...
export function MetricsSection({ metrics }: { metrics: { hero: Metric[]; supporting: Metric[] } }) {
    return (
        <motion.section
            initial="hidden"
            whileInView="visible"
                    ...
                    <motion.div key={m.label} variants={cardVariants}>
                        <Card>
                            <CardHeader className="pb-3">
                                <CardTitle className="text-2xl font-bold text-orange-500/80">
                                    <AnimatedCounter
                                        value={m.value}
                                        prefix={m.prefix}
                                        suffix={m.suffix}
