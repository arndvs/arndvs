...
describe("estimateReadingTime", () => {
    it("returns '1 min read' for empty or short content", () => {
        expect(estimateReadingTime(0)).toBe("1 min read");
        expect(estimateReadingTime(500)).toBe("1 min read");
    });

    it("calculates reading time and rounds up to the next minute", () => {
...
describe("formatDate", () => {
    it("formats with long month by default and short month when asked", () => {
