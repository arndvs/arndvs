...
**AI & Agents**
Claude Code · LLM Integration · Prompt Engineering · RAG · LangChain · Model Context Protocol · Anthropic · ElevenLabs

**Core stack**
TypeScript · React · Next.js · Sanity CMS · Node.js · Express · FastAPI · Python
